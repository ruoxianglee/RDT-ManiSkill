...
INSTRUCTION = "Grasp a brown cup from the horizontal direction and move it to a target goal position."

# Note: if your GPU VRAM is less than 24GB, 
# it is recommended to enable offloading by specifying an offload directory.
OFFLOAD_DIR = "/root/RDTEncodeLang/"  # Specify your offload directory here, ensuring the directory exists.
